...
import forcespire.controllers.ForceSpireController;
 ...
 */
public class ForceSpireApp extends JFrame implements ComponentListener {
     ...
     * Constants
     */
    private static final String DEFAULT_TITLE = "ForceSpire BETA";
    ...
    private static ArrayList<ForceSpireController> openProjects = new ArrayList<ForceSpireController>();
    private static Preferences prefs = Preferences.userNodeForPackage(ForceSpireApp.class);
    private ForceSpireController currentProject;
    ...
    private void initLookAndFeel() {
        ...
        if (MacOS) {
            try {
                ...
                Image dockIcon = new ImageIcon(getClass().getResource("/forcespire/images/Death-Star-icon-48.png")).getImage();
            ...
            this.setIconImage(new ImageIcon(getClass().getResource("/forcespire/images/Death-Star-icon-48.png")).getImage());
            try {
...
//            }
        ...
        setLocation(0, 0);
        System.out.println("starting ForceSPIRE with resolution: " + width + ", " + height);
    ...
    private void newProject() {
         ...
         * Start new Document
         */
        ForceSpireController theNewProject = new ForceSpireController(getSize().width, getSize().height);
    ...
    private void open() {
        ...
        File file = ForceSpireUtility.openFile("Open Drawing", "last_open_path", ForceSpireUtility.EXT_FILTER_JSON);
        if (file != null) {
            System.out.println("Open target:" + file.getAbsolutePath());
            try {
                ForceSpireController openProject = new ForceSpireController(file);
     ...
     */
    private void setCurrentProject(ForceSpireController project) {
     ...
     */
    private void saveAs() {
        File file = ForceSpireUtility.saveFile("Save Project As", "last_save_path", ForceSpireUtility.EXT_FILTER_JSON);
        if (file != null) {
