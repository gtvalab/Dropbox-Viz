...
public class GraphSearchView extends JInternalFrame implements InternalFrameListener, ComponentListener {
     ...
     */
    public GraphSearchView(SearchNode n, ForceSpireController c) {
        super("Untitled", false, false, false, true);
        updateLocation = true;
        node = n;
        controller = c;
        highlight = true;
        ...
        clear = new JButton(HIGHLIGHT_ON);
    ...
    public void getFocus() {
        try {
            ...
            logger.log(Level.SEVERE, "Couldn't five search box focus", ex);
        }
    }
