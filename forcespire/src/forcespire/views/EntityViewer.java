...
public class EntityViewer extends JFrame implements DataListener {
    ...
    private SortType sortBy = SortType.ABC; //default is ABC for sort
...
//    DefaultListModel<Entity> entities;
     ...
     */
    public EntityViewer(ForceSpireController fsc) {
        controller = fsc;
        selectedEntity = null;
    ...
    private void refreshDetailView() {
        if (selectedEntity == null) {
            ...
            entStrength.setText("" + selectedEntity.getStrength());
