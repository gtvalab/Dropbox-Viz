...
public class WeightedElasticLayout implements GraphLayout, GraphListener {
     ...
     */
    private final static int MAX_NUM_OF_ITERATIONS = 600;
    /**
     ...
     */
    private final static int COOLING_START_DELAY = 1500; //was 100, but I went to 1500 for LHRD
    /*
     ...
     */
    private final static int COOLING_DIVIDER = 800; //was 200, changed for LHRD
    /**
     ...
     * direction).
     */
    private final static double COOLING_FACTOR_MINIMUM = 0.0;
    /**
     * This is a flag to either enable (TRUE) of disable (FALSE) the cooling feature.
     */
    private final static boolean IS_COOLING = false;
    /**
     * This is the maximum amount of distance a node can move per "turn"
     */
    private final static double MAX_DIST_PER_MOVE = 10.0;
    /**
    ...
    private void doLayout() {
        ...
        while (maxVelocity > 1 && active && (numOfIterations < MAX_NUM_OF_ITERATIONS)) {
            ...
            while (outer.hasNext()) {
                ...
                controller.moveNode(current, current.getX() + (int) current.getVX(), current.getY() + (int) current.getVY());
     ...
     */
    public void setForceSpireController(ForceSpireController fs) {
        stop();
