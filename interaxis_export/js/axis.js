axis = function(elemid, vector, XorY, options) {
  ...
  // var errorBar = svg.selectAll(".errorbar")
  //     .data(data)
  //   .enter().append("line")
  //     .attr("class", "errorbar")
  //     .attr("x1", function(d) { return d["value"]>=0 ? x(d["value"]-d["error"]) : x(d["value"]); })
  //     .attr("y1", function(d) { return y(d["attr"])+y.rangeBand()/2; })
  //     .attr("x2", function(d) { return d["value"]>=0 ? x(d["value"]) : x(d["value"]+d["error"]); })
  //     .attr("y2", function(d) { return y(d["attr"])+y.rangeBand()/2; });
